...
```{r model}
model1 <- lm(hhincome ~ sex+age+ statebrn+marstat+edyrs+occtype+usdur1+usdurl+usdoc1+uscity+yrborn,
data=caldata)
...
kable(tidy(regfit_backward, conf.int = TRUE, exponentiate = TRUE), format = "markdown", digits = 8)
```
