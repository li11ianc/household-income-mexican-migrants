...
It turned out that all values from relhead in our cleaned data were "1" or head. So we will remove this variable, as well as state variables since we are only using California data. 

```{r remove relhead}
caldata <- subset(caldata, select = -c(relhead, usstatel, usstate1) )
caldata
```
