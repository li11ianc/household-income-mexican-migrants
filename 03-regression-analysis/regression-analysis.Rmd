...
tidy(int_model, exponentiate = FALSE, conf.int = TRUE) %>%
kable(digits = 3, format = "markdown")
```
...
```{r scatter-pairs}
pairs(log(hhincome) ~ yrborn + age +  usdur1 + usdurl, data = caldata,
      lower.panel = NULL)
```
...
Hence, we decide to drop either yrborn or age, and either usdur1 or usdurl.
