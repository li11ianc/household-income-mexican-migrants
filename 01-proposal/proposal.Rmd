...
From the scatterplot, it seems that there are no obvious relationship between years of education and log(household income). This is discouraging because we can infer that many of the immigrants are underemployed.
...
We will consider the potential interaction between principal occupation and number of years of school completed, since those are generally interconnected. 
