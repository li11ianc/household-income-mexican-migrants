...
For Agriculture, the predicted wage is $805.31. We are 95% confident that the actual salary falls in the interval of [695.6034, 915.0141].
...
```{r}
x8 <- data.frame(sex = "M" , age = 0, edyrs = 7.25, usdur1 = 0, usdurl = 0, statebrn="Bajío", occtype = "Service", usdoc1 = "Undocumented")
predict.lm(reduced_int_new_2, x8, interval = "confidence")
```

For Service industry, the predicted wage is $905.50. We are 95% confident that the actual salary falls in the interval of [814.7695, 996.2402].
...
For Professional workers, the predicted wage is $1182.06 We are 95% confident that the actual salary falls in the interval of [991.18, 1372.94].
